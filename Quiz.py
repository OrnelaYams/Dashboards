...
df = pd.read_csv("Day3-Dash/fragen.csv")
st.title("🧪 CSV-Quiz")
#Einführung
st.write("**Willkommen zu diesem Quiz! Beantworten Sie die unten stehenden Fragen und erfahren Sie am Ende Ihre Punktzahl.**")
